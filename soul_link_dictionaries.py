...
games = [
    ...
    {'Name': 'heartgold-soulsilver', 'Games': ['HeartGold', 'SoulSilver'], 'Colour': [14398266, 11778238], 'Link-Emoji': ['<:_:1193408899198500876>', '<:_:1193409003661828178>'], 'Mascot': [250, 249], 'Progression': [
                                            ...
                                            {'Stage': 4, 'Name': 'Morty', 'Battle-Name': 'Chuck', 'Level-Cap': 31, 'Encounters': ['Lapras Static', 'Route 27', 'Tohjo Falls', 'Route 43', 'Lake of Rage', 'Gyarados Static', 'Rocket HQ', 'Electrode Static', 'Route 41', 'Cianwood City', 'Shuckle Gift']},
                                            {'Stage': 5, 'Name': 'Chuck', 'Battle-Name': 'Jasmine', 'Level-Cap': 35, 'Encounters': ['Route 47', 'Cliff Cave', 'Route 48', 'Safari Zone Gate', 'Safari Zone']},
                                            {'Stage': 6, 'Name': 'Jasmine', 'Battle-Name': 'Pryce', 'Level-Cap': 35, 'Encounters': []},
                                            {'Stage': 7, 'Name': 'Pryce', 'Battle-Name': 'Claire', 'Level-Cap': 41, 'Encounters': ['Whirl Islands', 'Route 44', 'Ice Path', 'Blackthorn City', 'Route 45']},
