...
games = [
    ...
    {'Name': 'diamond-pearl', 'Games': ['Diamond', 'Pearl'], 'Colour': [5349551, 15576266], 'Link-Emoji': ['<:_:1193408726498029680>', '<:_:1193408782076743760>'], 'Mascot': [483, 484], 'Progression': [
                                                ...
                                                {'Stage': 1, 'Name': 'Roark', 'Battle-Name': 'Gardenia', 'Level-Cap': 22, 'Encounters': ['Floaroma Meadow', 'Route 205', 'Valley Windworks', 'Drifloon', 'Eterna Forest', 'Eterna City', 'Route 211', 'Mt. Coronet']}, 
                                                ...
                                                {'Stage': 7, 'Name': 'Candice', 'Battle-Name': 'Volkner', 'Level-Cap': 49, 'Encounters': ['Lake Acuity', 'Legendary', 'Mesprit', 'Lake Valor', 'Azelf', 'Uxie', 'Route 222', 'Sunnyshore City', 'Route 223', 'Pokemon League']},
    ...
    {'Name': 'platinum', 'Games': ['Platinum'], 'Colour': [1911153], 'Link-Emoji': ['<:_:1193408835759644762>'], 'Mascot': [10007], 'Progression': [
                                            {'Stage': 0, 'Name': 'Start', 'Battle-Name': 'Roark', 'Level-Cap': 14, 'Encounters': ['Starter', 'Route 201', 'Lake Verity', 'Route 202', 'Route 203', 'Route 204', 'Ravaged Path', 'Route 218', 'Route 219', 'Twinleaf Town', 'Oreburgh Gate', 'Oreburgh Mine', 'Route 207']},
                                            {'Stage': 1, 'Name': 'Roark', 'Battle-Name': 'Gardenia', 'Level-Cap': 22, 'Encounters': ['Floaroma Meadow', 'Route 205', 'Valley Windworks', 'Drifloon', 'Eterna Forest', 'Eterna City', 'Route 211', 'Mt. Coronet']},
                                            {'Stage': 2, 'Name': 'Gardenia', 'Battle-Name': 'Fantina', 'Level-Cap': 26, 'Encounters': ['Old Chateau', 'Rotom', 'Togepi Egg', 'Route 206', 'Wayward Cave', 'Route 208', 'Eevee Gift']},
                                            ...
                                            {'Stage': 7, 'Name': 'Candice', 'Battle-Name': 'Volkner', 'Level-Cap': 50, 'Encounters': ['Lake Acuity', 'Legendary', 'Sendoff Spring', 'Mesprit', 'Lake Valor', 'Azelf', 'Uxie', 'Route 222', 'Sunnyshore City', 'Route 223', 'Pokemon League']},
